...
pub mod paras_launchpad {
    ...
    use openbrush::{
        contracts::{
            ownable::*,
            psp34::extensions::{enumerable::*, metadata::*, burnable::*,},
        },
        modifiers,
    ...
    impl PSP34Burnable for ParasLaunchpadContract {}
    ...
    impl ParasLaunchpadContract {
        ...
        pub fn new(
            ...
            instance._set_attribute(collection_id, String::from("baseExtension"), base_extension);
    ...
    mod tests {
        ...
        fn init() -> ParasLaunchpadContract {
            ...
            ParasLaunchpadContract::new(
                ...
                String::from(BASE_EXTENSION),   // base_extension: String,
