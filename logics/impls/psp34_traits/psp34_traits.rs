        ...
        + Storage<Data>,
{
    ...
    fn set_base_extension(&mut self, uri: PreludeString) -> Result<(), PSP34Error> {
        let collection_id = self.data::<psp34::Data<enumerable::Balances>>().collection_id();
        self.data::<metadata::Data>()._set_attribute(collection_id, String::from("baseExtension"), uri.into_bytes());
        Ok(())
    }
